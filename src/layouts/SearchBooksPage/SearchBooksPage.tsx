...
export const SearchBooksPage = () => {
  ...
  const [totalAmountOfBooks, setTotalAmountOfBooks] = useState(0); // Total Books which we have
  const [totalPages, setTotalPages] = useState(0); // Total pages that we have

  // For Searching any book by title =======>>>>>>>>
